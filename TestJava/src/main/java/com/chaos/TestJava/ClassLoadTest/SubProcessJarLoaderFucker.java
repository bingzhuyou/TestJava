...
public class SubProcessJarLoaderFucker {
	...
	public static Class<?> loadSubProcessJars(String subProcessJars, String mainClassName, String separator,
		...
		ClassLoader parentLoader = SubProcessJarLoaderFucker.class.getClassLoader();// Thread.currentThread().getContextClassLoader();
