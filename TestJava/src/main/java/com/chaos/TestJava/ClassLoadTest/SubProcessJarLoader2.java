...
// URLClassLoader test is ok
public class SubProcessJarLoader2 {
	...
	public static Class<?> loadSubProcessJars(String subProcessJars, String mainClassName, String separator,
		...
		ClassLoader parentLoader = SubProcessJarLoader2.class.getClassLoader();// Thread.currentThread().getContextClassLoader();
